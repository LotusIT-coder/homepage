...
(function () {
  ...
  const TRANSLATIONS = {
    de: {
      'meta.title': 'Lotus Consulting | Marken- & Unternehmensberatung – Nische schärfen, sichtbar werden',
      'meta.description': 'Lotus Consulting: Marken- und Unternehmensberatung für Künstler:innen, Kreativschaffende, Musiker:innen, Trainer:innen, Coaches, Berater:innen sowie Vereine, NGOs, Stiftungen und kulturelle wie soziale Einrichtungen. Marke finden, Nische schärfen, Angebote ordnen, sichtbar werden.',
      ...
      'hero.badge': 'Marken- & Unternehmensberatung für wandelnde Angebote',
      'hero.headline': 'Wie wollt ihr wirken, wenn Menschen euch zum ersten Mal begegnen?',
      'hero.sub': 'Marken- und Unternehmensberatung & Webentwicklung für Künstler:innen, Kreative, Coaches, Vereine, NGOs und kulturelle Einrichtungen — wir liefern Positionierung, Angebotsstruktur, Sprache, Design und Website aus einer Hand, damit euer Auftritt innen wie außen dieselbe Klarheit trägt.',
      ...
      'services.copy': 'Nicht als starres Agenturpaket, sondern als geführter Beratungsprozess zwischen innerer Klarheit, Angebots- und Organisationsstruktur, äußerer Wirkung und digitaler Umsetzung.',
    ...
    en: {
      'meta.title': 'Lotus Consulting | Brand & business consulting — sharpen your niche, become visible',
      'meta.description': 'Lotus Consulting: brand and business consulting for artists, creatives, musicians, trainers, coaches and advisors as well as associations, NGOs, foundations and cultural or social institutions. Find your brand, sharpen your niche, structure your offers and become visible.',
      'banner.text': '🚧 <strong>Under Construction</strong> 🚧',
      ...
      'nav.menu': 'Open menu',
      'modal.close': 'Close',
      'hero.badge': 'Brand & business consulting for evolving offers',
      'hero.headline': 'How do you want to come across when people encounter you for the first time?',
      'hero.sub': 'Brand & business consulting and web development for artists, creatives, coaches, associations, NGOs and cultural institutions — we deliver positioning, offer structure, language, design and website from a single source so your presence carries the same clarity inside and out.',
      ...
      'diagnosis.copy': 'Whether you work with your personality – as an artist, creative, musician, trainer, coach or advisor – or appear as an association, NGO, foundation, or cultural or social institution: good marketing does not start with volume, but with clarity. We combine brand work with light-touch business consulting – ordering offers, clarifying roles, simplifying processes – so your idea becomes a viable presence. Who are you, what do you stand for, who do you want to reach and how should your offer feel?',
      ...
      'services.copy': 'Not as a rigid agency package, but as a guided consulting process between inner clarity, offer and organisational structure, outer impact and digital implementation.',
