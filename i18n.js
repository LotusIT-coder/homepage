...
const TRANSLATIONS = {
  de: {
    ...
    /* Hero */
    'hero.badge': 'IT-Sicherheits-Beratung · Systemanalyse · Prozessautomatisierung',
    'hero.h1':    'Verständliche Sicherheit.<br />Schnellere Fehleranalyse.<br /><em>Stabilere Systeme.</em>',
    'hero.sub':   'Ich berate Sie verständlich bei Sicherheitsfragen, analysiere echte Logdaten und automatisiere wiederkehrende Aufgaben – damit Ihre Anwendungen zuverlässig und sicher laufen.',
    ...
    'hero.chip3': 'Stabilere, sicherere Systeme',
    ...
    'svc.tag': 'Leistungen',
    'svc.h2':  'Drei Kernbereiche, ein klares Ziel: sicherere Systeme, weniger Aufwand',
    'svc.sub': 'Ich berate verständlich bei Sicherheitsfragen und übernehme dort, wo Standard-Support an Grenzen stößt – mit konkreten Ergebnissen statt Folien.',
    ...
    /* Service card 3 – IT-Sicherheits-Beratung & -Support */
    'svc3.h3':   'IT-Sicherheits-Beratung & -Support',
    'svc3.p':    'Ich berate verständlich bei Sicherheitsfragen aus dem Tagesgeschäft – von der Risikoeinschätzung über Härtungsempfehlungen bis hin zur Unterstützung bei konkreten Vorfällen.',
    'svc3.li1':  'Beratung bei Sicherheitsfragen im Tagesgeschäft',
    'svc3.li2':  'Risiken einschätzen und priorisieren',
    'svc3.li3':  'Härtungsempfehlungen statt pauschaler Checklisten',
    'svc3.li4':  'Unterstützung bei sicherheitsrelevanten Vorfällen',
    'svc3.li5':  '',
    ...
    'p2.h3':  'Startpaket: Sicherheits-Support',
    'p2.sub': 'Festes monatliches Kontingent – fester Ansprechpartner für Sicherheitsfragen, Risiko-Reviews und Vorfall-Unterstützung.',
    'p2.li1': '5–20 h/Monat wählbar',
    'p2.li2': 'Günstigerer Stundensatz',
    'p2.li3': 'Vorrang bei Vorfällen',
    'p2.li4': 'Beratung bei Sicherheitsfragen',
    'p2.li5': 'Risiko-Reviews & Härtungsempfehlungen',
    'p2.li6': 'Monatliches Status-Update',
    'p2.cta': 'Sicherheits-Paket anfragen',
    ...
    'about.v3.text':         'Verständliche Sicherheits­entscheidungen, schnellere Analysen, stabilere Systeme – messbar',
    ...
    'about.t.v3': 'IT-Sicherheits-Beratung & -Support',
    ...
    'faq4.a': 'Ja. Ich docke an Ihre bestehenden Prozesse an, übernehme abgegrenzte sicherheits- oder supportseitige Fälle und gebe nachvollziehbare Lösungen zurück – inklusive Wissenstransfer.',
    'faq5.q': 'Bieten Sie auch laufende Betreuung an?',
    'faq5.a': 'Ja, im Rahmen des Sicherheits-Support-Startpakets. Sie haben damit ein festes monatliches Stundenkontingent und Vorrang bei sicherheitsrelevanten Anliegen.',
    ...
    'form.opt.security':    'IT-Sicherheits-Beratung & -Support',
    ...
    /* Footer */
    'footer.tagline':   'IT-Sicherheits-Beratung · Systemanalyse & Debugging · Prozessautomatisierung',
    ...
    'mki.faq3.a':       'Auf Wunsch ja. Aus dem Befund wird direkt die Umsetzung – als Fix, Patch oder dauerhafte Stabilisierung im Sicherheits-Support-Paket.',
    'mki.cta':          'System analysieren lassen →',

    /* Modal: IT-Sicherheits-Beratung & -Support */
    'msec.title':       'IT-Sicherheits-Beratung & -Support',
    'msec.sub':         'Verständliche Antworten auf konkrete Sicherheitsfragen – statt allgemeiner Compliance-Folien oder Buzzword-Berge.',
    'msec.s1.h':        '🛡️ Beratung bei Sicherheitsfragen im Tagesgeschäft',
    'msec.s1.p':        'Ob Phishing-Verdacht, neue Anwendung, Cloud-Migration oder Zugriffsrechte: Sie bekommen <strong>verständliche Einschätzungen</strong> statt unklarer Risikomatrizen. Ich helfe Ihnen, sicherheitsrelevante Entscheidungen sauber zu treffen – mit klarer Empfehlung.',
    'msec.s1.hl.title': 'Typische Anlässe',
    'msec.s1.hl.text':  'Phishing-Verdacht · neue Anwendung freigeben · Cloud-/SaaS-Bewertung · Zugriffsrechte aufräumen',
    'msec.s2.h':        '🔍 Risiken einschätzen und priorisieren',
    'msec.s2.p':        'Statt einer endlosen Mängelliste bekommen Sie eine kurze, priorisierte Übersicht: Was tatsächlich ein Risiko ist, was nur Theorie und was wirklich zuerst angegangen werden sollte – mit Bezug auf Ihren konkreten Betrieb.',
    'msec.s2.hl.title': 'Vorgehen',
    'msec.s2.hl.text':  'Bestand sichten · realistische Bedrohungen identifizieren · Maßnahmen nach Wirkung priorisieren',
    'msec.s3.h':        '🚨 Unterstützung bei sicherheitsrelevanten Vorfällen',
    'msec.s3.p':        'Bei einem akuten Vorfall – Phishing-Klick, kompromittierter Account, ungewöhnliche Aktivität – unterstütze ich Sie strukturiert: Sofortmaßnahmen, sauberes Aufräumen, Lessons Learned. Ohne Panik, ohne übertriebene Eskalation.',
    'msec.faq.h':       'Häufige Fragen',
    'msec.faq1.q':      'Was ist ein typischer Anlass, Sie hinzuzuziehen?',
    'msec.faq1.a':      'Konkrete Sicherheitsfragen aus dem Tagesgeschäft: ein Verdacht, eine geplante Änderung, eine Audit-Anforderung oder ein akuter Vorfall. Ich helfe einzuordnen, was wirklich relevant ist – und was zuerst getan werden sollte.',
    'msec.faq2.q':      'Ersetzt das ein Sicherheitskonzept oder Audit?',
    'msec.faq2.a':      'Nein – ich biete praktische Beratung und Unterstützung im laufenden Betrieb. Für formale Audits oder Zertifizierungen arbeite ich gerne mit spezialisierten Auditoren zusammen.',
    'msec.faq3.q':      'Bieten Sie auch laufende Begleitung an?',
    'msec.faq3.a':      'Ja, im Rahmen eines Sicherheits-Support-Startpakets. Damit haben Sie einen festen Ansprechpartner für Sicherheitsfragen und ein monatliches Stundenkontingent.',
    'msec.cta':         'Sicherheitsfrage besprechen →',
  },
  ...
  en: {
    ...
    /* Hero */
    'hero.badge': 'IT Security Consulting · System Analysis · Process Automation',
    'hero.h1':    'Understandable security.<br />Faster root-cause analysis.<br /><em>More stable systems.</em>',
    'hero.sub':   'I provide clear advice on security questions, analyse real log data and automate repetitive tasks – so your applications run reliably and securely.',
    'hero.cta1':  'Explore services',
    'hero.cta2':  'Get in touch',
    'hero.chip1': 'Fewer recurring tickets',
    'hero.chip2': 'Faster root-cause analysis',
    'hero.chip3': 'More stable, more secure systems',
    ...
    /* Services section header */
    'svc.tag': 'Services',
    'svc.h2':  'Three core services, one clear goal: more secure systems, less effort',
    'svc.sub': 'I provide clear advice on security questions and step in where standard support hits its limits – with concrete results instead of slides.',
    ...
    /* Service card 3 – IT Security Consulting & Support */
    'svc3.h3':   'IT Security Consulting & Support',
    'svc3.p':    'Clear advice on day-to-day security questions – from risk assessment and hardening recommendations to support during concrete incidents.',
    'svc3.li1':  'Advice on day-to-day security questions',
    'svc3.li2':  'Assess and prioritise risks',
    'svc3.li3':  'Hardening recommendations instead of generic checklists',
    'svc3.li4':  'Support during security-relevant incidents',
    'svc3.li5':  '',
    'svc3.link': 'Request →',
    ...
    'p2.h3':  'Starter: Security Support',
    'p2.sub': 'Fixed monthly hours – a dedicated contact for security questions, risk reviews and incident support.',
    'p2.li1': '5–20 h/month selectable',
    'p2.li2': 'Reduced hourly rate',
    'p2.li3': 'Priority on incidents',
    'p2.li4': 'Advice on security questions',
    'p2.li5': 'Risk reviews & hardening recommendations',
    'p2.li6': 'Monthly status update',
    'p2.cta': 'Request security package',
    ...
    'about.v3.text':         'Understandable security decisions, faster analysis, more stable systems – measurable',
    ...
    'about.t.v3': 'IT Security Consulting & Support',
    ...
    'faq4.a': 'Yes. I plug into your existing processes, take on scoped security or support cases and hand back traceable solutions – including knowledge transfer.',
    'faq5.q': 'Do you also offer ongoing support?',
    'faq5.a': 'Yes, as part of the security support starter package. You get a fixed monthly hour budget and priority on security-relevant matters.',
    ...
    'form.opt.security':    'IT Security Consulting & Support',
    ...
    /* Footer */
    'footer.tagline':   'IT Security Consulting · System Analysis & Debugging · Process Automation',
    ...
    'mki.faq3.a':       'On request, yes. The analysis turns directly into implementation – as a fix, patch or lasting stabilisation as part of the security support package.',
    'mki.cta':          'Have my system analysed →',

    /* Modal: IT Security Consulting & Support */
    'msec.title':       'IT Security Consulting & Support',
    'msec.sub':         'Clear answers to concrete security questions – instead of generic compliance slides or buzzword piles.',
    'msec.s1.h':        '🛡️ Advice on day-to-day security questions',
    'msec.s1.p':        'Whether a phishing suspicion, a new application, a cloud migration or access rights: you get <strong>understandable assessments</strong> instead of unclear risk matrices. I help you make security-relevant decisions cleanly – with a clear recommendation.',
    'msec.s1.hl.title': 'Typical occasions',
    'msec.s1.hl.text':  'Phishing suspicion · approving a new application · cloud / SaaS evaluation · cleaning up access rights',
    'msec.s2.h':        '🔍 Assess and prioritise risks',
    'msec.s2.p':        'Instead of an endless list of findings you get a short, prioritised overview: what is actually a risk, what is only theory, and what should really be tackled first – in the context of your concrete operation.',
    'msec.s2.hl.title': 'Approach',
    'msec.s2.hl.text':  'Review the landscape · identify realistic threats · prioritise measures by impact',
    'msec.s3.h':        '🚨 Support during security-relevant incidents',
    'msec.s3.p':        'In an acute incident – phishing click, compromised account, unusual activity – I support you in a structured way: immediate measures, clean clean-up, lessons learned. No panic, no over-escalation.',
    'msec.faq.h':       'Frequently Asked Questions',
    'msec.faq1.q':      'What is a typical reason to bring you in?',
    'msec.faq1.a':      'Concrete security questions from day-to-day operations: a suspicion, a planned change, an audit requirement or an acute incident. I help to put things into perspective – and to decide what to do first.',
    'msec.faq2.q':      'Does this replace a security concept or audit?',
    'msec.faq2.a':      'No – I provide practical advice and support during ongoing operations. For formal audits or certifications, I am happy to work alongside specialised auditors.',
    'msec.faq3.q':      'Do you also offer ongoing accompaniment?',
    'msec.faq3.a':      'Yes, as part of a security support starter package. You then have a dedicated contact for security questions and a fixed monthly hour budget.',
    'msec.cta':         'Discuss a security question →',
  },
};
